package com.jta.in.blog.controllers;

import java.util.Objects;


import com.jta.in.blog.config.JwtTokenUtil;
import com.jta.in.blog.constants.ApplicationConstants;
import com.jta.in.blog.constants.EnumConstants;
import com.jta.in.blog.exception.UserException;
import com.jta.in.blog.model.JwtResponse;
import com.jta.in.blog.model.UserModel;
import com.jta.in.blog.services.JwtUserDetailsService;
import com.jta.in.blog.utils.model.CustomResponse;
import com.jta.in.blog.utils.model.Message;
import com.jta.in.blog.model.JwtRequest;
...
public class JwtAuthenticationController {
    ...
    private void authenticate(String username, String password) throws Exception {
        ...
        try {
            ...
            throw new Exception(ApplicationConstants.INVALID_CREDENTIALS, e);
